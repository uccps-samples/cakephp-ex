          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>How to use this example application</h2>
                <p>For instructions on how to use this application with UCCPS, start by reading the <a href="http://docs.okd.io/latest/dev_guide/templates.html#using-the-quickstart-templates">Developer Guide</a>.</p>

              <h2>Deploying code changes</h2>
                <p>
                  The source code for this application is available to be forked from the <a href="https://www.github.com/utccp/cakephp-ex">UCCPS GitHub repository</a>.
...
<ol>
  ...
  <li>Paste your webhook URL provided by UCCPS</li>
  <li>Leave the defaults for the remaining fields &mdash; that's it!</li>
</ol>
<p>After you save your webhook, if you refresh your settings page you can see the status of the ping that Github sent to UCCPS to verify it can reach the server.</p>
<p>Note: adding a webhook requires your UCCPS server to be reachable from GitHub.</p>

                <h3>Working in your local Git repository</h3>
                <p>If you forked the application from the UCCPS GitHub example, you'll need to manually clone the repository to your local system. Copy the application's source code Git URL and then run:</p>

<pre>$ git clone &lt;git_url&gt; &lt;directory_to_create&gt;

# Within your project directory
# Commit your changes and push to UCCPS
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h2>Development Resources</h2>
                  <ul>
                    ...
                    <li><a href="https://github.com/utccp/origin">UCCPS Origin GitHub</a></li>
                    <li><a href="https://github.com/utccp/source-to-image">Source To Image GitHub</a></li>
                    <li><a href="http://docs.okd.io/latest/using_images/s2i_images/php.html">Getting Started with PHP on UCCPS</a></li>
